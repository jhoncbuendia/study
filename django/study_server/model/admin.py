...
class CursoAdmin(admin.ModelAdmin):
    list_display = ('nombre','precio_colombia', 'precio_newzealand', 'numero_horas_total', 'numero_horas_semana', 'puede_trabajar', 'pais','escuela', 'fecha_creacion',  )
...
class AlojamientoAdmin(admin.ModelAdmin):
    list_display = ('nombre', 'costo', 'ubicacion', )
    #list_filter = (' ',)
...
class ReservaAdmin(admin.ModelAdmin):
    list_display = ('nombre', 'apellido', 'whatsapp', 'plan','fecha_creacion' , 'agencia', )
    list_filter = ('nombre', 'apellido', 'whatsapp', 'plan','fecha_creacion', 'agencia',)
    search_fields = ['nombre', 'apellido', 'whatsapp', 'plan',  ]
    #filter_horizontal = ('Actividades',)
